...
import (
	...
	"kubevault.dev/apimachinery/apis/catalog/fuzzer"
	"kubevault.dev/apimachinery/apis/catalog/v1alpha1"
...
func TestPruneTypes(t *testing.T) {
	...
	// CRD v1
	if crd := (v1alpha1.VaultServerVersion{}).CustomResourceDefinition(); crd.V1 != nil {
		crdfuzz.SchemaFuzzTestForV1CRD(t, clientsetscheme.Scheme, crd.V1, fuzzer.Funcs)
	}

	// CRD v1beta1
	if crd := (v1alpha1.VaultServerVersion{}).CustomResourceDefinition(); crd.V1beta1 != nil {
