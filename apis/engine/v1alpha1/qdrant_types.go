...
const (
	ResourceKindQdrantRole = "QdrantRole"
	ResourceQdrantRole     = "qdrantrole"
	ResourceQdrantRoles    = "qdrantroles"
)
...
// +kubebuilder:resource:path=qdrantroles,singular=qdrantrole,categories={vault,appscode,all}
// +kubebuilder:subresource:status
// +kubebuilder:printcolumn:name="Status",type="string",JSONPath=".status.phase"
// +kubebuilder:printcolumn:name="Age",type="date",JSONPath=".metadata.creationTimestamp"
type QdrantRole struct {
	metav1.TypeMeta   `json:",inline,omitempty"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              QdrantRoleSpec `json:"spec,omitempty"`
...
type QdrantRoleList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	// Items is a list of QdrantRole objects
	Items []QdrantRole `json:"items,omitempty"`
}
