...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*RelayPlacementStatus)(nil), (*v1alpha2.RelayPlacementStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_RelayPlacementStatus_To_v1alpha2_RelayPlacementStatus(a.(*RelayPlacementStatus), b.(*v1alpha2.RelayPlacementStatus), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha2.RelayPlacementStatus)(nil), (*RelayPlacementStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_RelayPlacementStatus_To_v1alpha1_RelayPlacementStatus(a.(*v1alpha2.RelayPlacementStatus), b.(*RelayPlacementStatus), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_RelayPlacementStatus_To_v1alpha2_RelayPlacementStatus(in *RelayPlacementStatus, out *v1alpha2.RelayPlacementStatus, s conversion.Scope) error {
...
// Convert_v1alpha1_RelayPlacementStatus_To_v1alpha2_RelayPlacementStatus is an autogenerated conversion function.
func Convert_v1alpha1_RelayPlacementStatus_To_v1alpha2_RelayPlacementStatus(in *RelayPlacementStatus, out *v1alpha2.RelayPlacementStatus, s conversion.Scope) error {
	return autoConvert_v1alpha1_RelayPlacementStatus_To_v1alpha2_RelayPlacementStatus(in, out, s)
}

func autoConvert_v1alpha2_RelayPlacementStatus_To_v1alpha1_RelayPlacementStatus(in *v1alpha2.RelayPlacementStatus, out *RelayPlacementStatus, s conversion.Scope) error {
	out.Placement = in.Placement
	out.Selected = in.Selected
	out.Applied = in.Applied
	out.Ready = in.Ready
...
// Convert_v1alpha2_RelayPlacementStatus_To_v1alpha1_RelayPlacementStatus is an autogenerated conversion function.
func Convert_v1alpha2_RelayPlacementStatus_To_v1alpha1_RelayPlacementStatus(in *v1alpha2.RelayPlacementStatus, out *RelayPlacementStatus, s conversion.Scope) error {
	return autoConvert_v1alpha2_RelayPlacementStatus_To_v1alpha1_RelayPlacementStatus(in, out, s)
}
...
func autoConvert_v1alpha1_VaultServerStatus_To_v1alpha2_VaultServerStatus(in *VaultServerStatus, out *v1alpha2.VaultServerStatus, s conversion.Scope) error {
	...
	out.RelayPlacement = (*v1alpha2.RelayPlacementStatus)(unsafe.Pointer(in.RelayPlacement))
	return nil
}
...
func autoConvert_v1alpha2_VaultServerStatus_To_v1alpha1_VaultServerStatus(in *v1alpha2.VaultServerStatus, out *VaultServerStatus, s conversion.Scope) error {
	...
	out.RelayPlacement = (*RelayPlacementStatus)(unsafe.Pointer(in.RelayPlacement))
	return nil
}
