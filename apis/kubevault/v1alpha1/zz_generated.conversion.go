...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*AgentPlacementStatus)(nil), (*v1alpha2.AgentPlacementStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_AgentPlacementStatus_To_v1alpha2_AgentPlacementStatus(a.(*AgentPlacementStatus), b.(*v1alpha2.AgentPlacementStatus), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha2.AgentPlacementStatus)(nil), (*AgentPlacementStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_AgentPlacementStatus_To_v1alpha1_AgentPlacementStatus(a.(*v1alpha2.AgentPlacementStatus), b.(*AgentPlacementStatus), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*SpokeClusterStatus)(nil), (*v1alpha2.SpokeClusterStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_SpokeClusterStatus_To_v1alpha2_SpokeClusterStatus(a.(*SpokeClusterStatus), b.(*v1alpha2.SpokeClusterStatus), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha2.SpokeClusterStatus)(nil), (*SpokeClusterStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_SpokeClusterStatus_To_v1alpha1_SpokeClusterStatus(a.(*v1alpha2.SpokeClusterStatus), b.(*SpokeClusterStatus), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_AgentPlacementStatus_To_v1alpha2_AgentPlacementStatus(in *AgentPlacementStatus, out *v1alpha2.AgentPlacementStatus, s conversion.Scope) error {
	out.Placement = in.Placement
	out.Selected = in.Selected
	out.Applied = in.Applied
	out.Ready = in.Ready
	out.Clusters = *(*[]v1alpha2.SpokeClusterStatus)(unsafe.Pointer(&in.Clusters))
	return nil
}

// Convert_v1alpha1_AgentPlacementStatus_To_v1alpha2_AgentPlacementStatus is an autogenerated conversion function.
func Convert_v1alpha1_AgentPlacementStatus_To_v1alpha2_AgentPlacementStatus(in *AgentPlacementStatus, out *v1alpha2.AgentPlacementStatus, s conversion.Scope) error {
	return autoConvert_v1alpha1_AgentPlacementStatus_To_v1alpha2_AgentPlacementStatus(in, out, s)
}

func autoConvert_v1alpha2_AgentPlacementStatus_To_v1alpha1_AgentPlacementStatus(in *v1alpha2.AgentPlacementStatus, out *AgentPlacementStatus, s conversion.Scope) error {
	out.Placement = in.Placement
	out.Selected = in.Selected
	out.Applied = in.Applied
	out.Ready = in.Ready
	out.Clusters = *(*[]SpokeClusterStatus)(unsafe.Pointer(&in.Clusters))
	return nil
}

// Convert_v1alpha2_AgentPlacementStatus_To_v1alpha1_AgentPlacementStatus is an autogenerated conversion function.
func Convert_v1alpha2_AgentPlacementStatus_To_v1alpha1_AgentPlacementStatus(in *v1alpha2.AgentPlacementStatus, out *AgentPlacementStatus, s conversion.Scope) error {
	return autoConvert_v1alpha2_AgentPlacementStatus_To_v1alpha1_AgentPlacementStatus(in, out, s)
}
...
func autoConvert_v1alpha1_SpokeClusterStatus_To_v1alpha2_SpokeClusterStatus(in *SpokeClusterStatus, out *v1alpha2.SpokeClusterStatus, s conversion.Scope) error {
...
// Convert_v1alpha1_SpokeClusterStatus_To_v1alpha2_SpokeClusterStatus is an autogenerated conversion function.
func Convert_v1alpha1_SpokeClusterStatus_To_v1alpha2_SpokeClusterStatus(in *SpokeClusterStatus, out *v1alpha2.SpokeClusterStatus, s conversion.Scope) error {
	return autoConvert_v1alpha1_SpokeClusterStatus_To_v1alpha2_SpokeClusterStatus(in, out, s)
}

func autoConvert_v1alpha2_SpokeClusterStatus_To_v1alpha1_SpokeClusterStatus(in *v1alpha2.SpokeClusterStatus, out *SpokeClusterStatus, s conversion.Scope) error {
	out.ClusterName = in.ClusterName
	out.Phase = in.Phase
	out.TokenExpiry = (*metav1.Time)(unsafe.Pointer(in.TokenExpiry))
	out.CertExpiry = (*metav1.Time)(unsafe.Pointer(in.CertExpiry))
...
// Convert_v1alpha2_SpokeClusterStatus_To_v1alpha1_SpokeClusterStatus is an autogenerated conversion function.
func Convert_v1alpha2_SpokeClusterStatus_To_v1alpha1_SpokeClusterStatus(in *v1alpha2.SpokeClusterStatus, out *SpokeClusterStatus, s conversion.Scope) error {
	return autoConvert_v1alpha2_SpokeClusterStatus_To_v1alpha1_SpokeClusterStatus(in, out, s)
}
...
func autoConvert_v1alpha2_VaultServerSpec_To_v1alpha1_VaultServerSpec(in *v1alpha2.VaultServerSpec, out *VaultServerSpec, s conversion.Scope) error {
	...
	// WARNING: in.AgentPlacementRef requires manual conversion: does not exist in peer-type
	// WARNING: in.AgentTemplate requires manual conversion: does not exist in peer-type
	return nil
}
