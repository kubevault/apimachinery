...
import (
	...
	"kubevault.dev/apimachinery/apis/ops/fuzzer"
	"kubevault.dev/apimachinery/apis/ops/v1alpha1"
...
func TestPruneTypes(t *testing.T) {
	...
	// CRD v1
	if crd := (v1alpha1.VaultOpsRequest{}).CustomResourceDefinition(); crd.V1 != nil {
		crdfuzz.SchemaFuzzTestForV1CRD(t, clientsetscheme.Scheme, crd.V1, fuzzer.Funcs)
	}

	// CRD v1beta1
	if crd := (v1alpha1.VaultOpsRequest{}).CustomResourceDefinition(); crd.V1beta1 != nil {
