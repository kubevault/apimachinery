...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OIDCSubjectRef) DeepCopyInto(out *OIDCSubjectRef) {
	*out = *in
	if in.BoundAudiences != nil {
		in, out := &in.BoundAudiences, &out.BoundAudiences
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OIDCSubjectRef.
func (in *OIDCSubjectRef) DeepCopy() *OIDCSubjectRef {
	if in == nil {
		return nil
	}
	out := new(OIDCSubjectRef)
	in.DeepCopyInto(out)
	return out
}
