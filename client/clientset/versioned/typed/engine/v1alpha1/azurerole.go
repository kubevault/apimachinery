...
func (c *azureRoles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AzureRole, err error) {
...
func (c *azureRoles) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AzureRoleList, err error) {
...
func (c *azureRoles) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *azureRoles) Create(ctx context.Context, azureRole *v1alpha1.AzureRole, opts v1.CreateOptions) (result *v1alpha1.AzureRole, err error) {
	result = &v1alpha1.AzureRole{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("azureroles").
...
func (c *azureRoles) Update(ctx context.Context, azureRole *v1alpha1.AzureRole, opts v1.UpdateOptions) (result *v1alpha1.AzureRole, err error) {
	result = &v1alpha1.AzureRole{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("azureroles").
...
func (c *azureRoles) UpdateStatus(ctx context.Context, azureRole *v1alpha1.AzureRole, opts v1.UpdateOptions) (result *v1alpha1.AzureRole, err error) {
	result = &v1alpha1.AzureRole{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("azureroles").
...
func (c *azureRoles) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *azureRoles) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *azureRoles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AzureRole, err error) {
	result = &v1alpha1.AzureRole{}
