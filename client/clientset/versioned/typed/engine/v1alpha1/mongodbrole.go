...
func newMongoDBRoles(c *EngineV1alpha1Client, namespace string) *mongoDBRoles {
	return &mongoDBRoles{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *mongoDBRoles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MongoDBRole, err error) {
...
func (c *mongoDBRoles) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MongoDBRoleList, err error) {
...
func (c *mongoDBRoles) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *mongoDBRoles) Create(ctx context.Context, mongoDBRole *v1alpha1.MongoDBRole, opts v1.CreateOptions) (result *v1alpha1.MongoDBRole, err error) {
	result = &v1alpha1.MongoDBRole{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mongodbroles").
...
func (c *mongoDBRoles) Update(ctx context.Context, mongoDBRole *v1alpha1.MongoDBRole, opts v1.UpdateOptions) (result *v1alpha1.MongoDBRole, err error) {
	result = &v1alpha1.MongoDBRole{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mongodbroles").
...
func (c *mongoDBRoles) UpdateStatus(ctx context.Context, mongoDBRole *v1alpha1.MongoDBRole, opts v1.UpdateOptions) (result *v1alpha1.MongoDBRole, err error) {
	result = &v1alpha1.MongoDBRole{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mongodbroles").
...
func (c *mongoDBRoles) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *mongoDBRoles) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *mongoDBRoles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MongoDBRole, err error) {
	result = &v1alpha1.MongoDBRole{}
