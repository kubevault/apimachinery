...
func (c *mySQLRoles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MySQLRole, err error) {
...
func (c *mySQLRoles) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MySQLRoleList, err error) {
...
func (c *mySQLRoles) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *mySQLRoles) Create(ctx context.Context, mySQLRole *v1alpha1.MySQLRole, opts v1.CreateOptions) (result *v1alpha1.MySQLRole, err error) {
	result = &v1alpha1.MySQLRole{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mysqlroles").
...
func (c *mySQLRoles) Update(ctx context.Context, mySQLRole *v1alpha1.MySQLRole, opts v1.UpdateOptions) (result *v1alpha1.MySQLRole, err error) {
	result = &v1alpha1.MySQLRole{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mysqlroles").
...
func (c *mySQLRoles) UpdateStatus(ctx context.Context, mySQLRole *v1alpha1.MySQLRole, opts v1.UpdateOptions) (result *v1alpha1.MySQLRole, err error) {
	result = &v1alpha1.MySQLRole{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mysqlroles").
...
func (c *mySQLRoles) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *mySQLRoles) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *mySQLRoles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MySQLRole, err error) {
	result = &v1alpha1.MySQLRole{}
