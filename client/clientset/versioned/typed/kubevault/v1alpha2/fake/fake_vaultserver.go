...
var vaultserversResource = schema.GroupVersionResource{Group: "kubevault.com", Version: "v1alpha2", Resource: "vaultservers"}

var vaultserversKind = schema.GroupVersionKind{Group: "kubevault.com", Version: "v1alpha2", Kind: "VaultServer"}
...
func (c *FakeVaultServers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.VaultServer, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(vaultserversResource, c.ns, name), &v1alpha2.VaultServer{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.VaultServer), err
}
...
func (c *FakeVaultServers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.VaultServerList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(vaultserversResource, vaultserversKind, c.ns, opts), &v1alpha2.VaultServerList{})
	...
	list := &v1alpha2.VaultServerList{ListMeta: obj.(*v1alpha2.VaultServerList).ListMeta}
	for _, item := range obj.(*v1alpha2.VaultServerList).Items {
...
func (c *FakeVaultServers) Create(ctx context.Context, vaultServer *v1alpha2.VaultServer, opts v1.CreateOptions) (result *v1alpha2.VaultServer, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(vaultserversResource, c.ns, vaultServer), &v1alpha2.VaultServer{})
...
func (c *FakeVaultServers) Update(ctx context.Context, vaultServer *v1alpha2.VaultServer, opts v1.UpdateOptions) (result *v1alpha2.VaultServer, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(vaultserversResource, c.ns, vaultServer), &v1alpha2.VaultServer{})
...
func (c *FakeVaultServers) UpdateStatus(ctx context.Context, vaultServer *v1alpha2.VaultServer, opts v1.UpdateOptions) (*v1alpha2.VaultServer, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(vaultserversResource, "status", c.ns, vaultServer), &v1alpha2.VaultServer{})
...
func (c *FakeVaultServers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(vaultserversResource, c.ns, name, opts), &v1alpha2.VaultServer{})
...
func (c *FakeVaultServers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha2.VaultServerList{})
	return err
}
...
func (c *FakeVaultServers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.VaultServer, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(vaultserversResource, c.ns, name, pt, data, subresources...), &v1alpha2.VaultServer{})
