...
type OpsV1alpha1Interface interface {
	...
	VaultOpsRequestsGetter
}

// OpsV1alpha1Client is used to interact with features provided by the ops.kubevault.com group.
type OpsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *OpsV1alpha1Client) VaultOpsRequests(namespace string) VaultOpsRequestInterface {
	return newVaultOpsRequests(c, namespace)
}
...
func setConfigDefaults(config *rest.Config) {
	gv := opsv1alpha1.SchemeGroupVersion
