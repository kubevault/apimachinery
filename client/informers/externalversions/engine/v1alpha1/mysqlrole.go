...
type MySQLRoleInformer interface {
	...
	Lister() enginev1alpha1.MySQLRoleLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EngineV1alpha1().MySQLRoles(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EngineV1alpha1().MySQLRoles(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EngineV1alpha1().MySQLRoles(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EngineV1alpha1().MySQLRoles(namespace).Watch(ctx, options)
			},
		},
		&apisenginev1alpha1.MySQLRole{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *mySQLRoleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisenginev1alpha1.MySQLRole{}, f.defaultInformer)
}

func (f *mySQLRoleInformer) Lister() enginev1alpha1.MySQLRoleLister {
	return enginev1alpha1.NewMySQLRoleLister(f.Informer().GetIndexer())
}
