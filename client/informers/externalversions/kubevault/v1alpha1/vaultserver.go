...
import (
	...
	apiskubevaultv1alpha1 "kubevault.dev/apimachinery/apis/kubevault/v1alpha1"
	...
	kubevaultv1alpha1 "kubevault.dev/apimachinery/client/listers/kubevault/v1alpha1"
...
type VaultServerInformer interface {
	...
	Lister() kubevaultv1alpha1.VaultServerLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubevaultV1alpha1().VaultServers(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubevaultV1alpha1().VaultServers(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubevaultV1alpha1().VaultServers(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubevaultV1alpha1().VaultServers(namespace).Watch(ctx, options)
			},
		},
		&apiskubevaultv1alpha1.VaultServer{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *vaultServerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiskubevaultv1alpha1.VaultServer{}, f.defaultInformer)
}

func (f *vaultServerInformer) Lister() kubevaultv1alpha1.VaultServerLister {
	return kubevaultv1alpha1.NewVaultServerLister(f.Informer().GetIndexer())
}
