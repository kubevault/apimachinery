...
type VaultRelayInformer interface {
	...
	Lister() kubevaultv1alpha2.VaultRelayLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubevaultV1alpha2().VaultRelays(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubevaultV1alpha2().VaultRelays(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubevaultV1alpha2().VaultRelays(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubevaultV1alpha2().VaultRelays(namespace).Watch(ctx, options)
			},
		},
		&apiskubevaultv1alpha2.VaultRelay{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *vaultRelayInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiskubevaultv1alpha2.VaultRelay{}, f.defaultInformer)
}

func (f *vaultRelayInformer) Lister() kubevaultv1alpha2.VaultRelayLister {
	return kubevaultv1alpha2.NewVaultRelayLister(f.Informer().GetIndexer())
}
