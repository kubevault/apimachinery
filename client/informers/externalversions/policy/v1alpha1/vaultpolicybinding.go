...
// VaultPolicyBindingInformer provides access to a shared informer and lister for
// VaultPolicyBindings.
...
// NewVaultPolicyBindingInformer constructs a new informer for VaultPolicyBinding type.
...
func NewVaultPolicyBindingInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewFilteredVaultPolicyBindingInformer(client, namespace, resyncPeriod, indexers, nil)
}

// NewFilteredVaultPolicyBindingInformer constructs a new informer for VaultPolicyBinding type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
...
func (f *vaultPolicyBindingInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredVaultPolicyBindingInformer(client, f.namespace, resyncPeriod, cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc}, f.tweakListOptions)
}
