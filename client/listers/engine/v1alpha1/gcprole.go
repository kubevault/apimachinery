...
type GCPRoleLister interface {
	...
	List(selector labels.Selector) (ret []*enginev1alpha1.GCPRole, err error)
...
type gCPRoleLister struct {
	listers.ResourceIndexer[*enginev1alpha1.GCPRole]
}

// NewGCPRoleLister returns a new GCPRoleLister.
func NewGCPRoleLister(indexer cache.Indexer) GCPRoleLister {
	return &gCPRoleLister{listers.New[*enginev1alpha1.GCPRole](indexer, enginev1alpha1.Resource("gcprole"))}
}

// GCPRoles returns an object that can list and get GCPRoles.
func (s *gCPRoleLister) GCPRoles(namespace string) GCPRoleNamespaceLister {
	return gCPRoleNamespaceLister{listers.NewNamespaced[*enginev1alpha1.GCPRole](s.ResourceIndexer, namespace)}
}
...
type GCPRoleNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*enginev1alpha1.GCPRole, error)
